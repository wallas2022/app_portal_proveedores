  ...
  return (
    <Box w={isExpanded ? "200px" : "41px"} bg="gray.200"  transition="width 0.5s">
      ...
      <VStack align="stretch" pl={2}>
        <MenuItem  _hover={{ bg: 'brand.600', color: 'white' }} icon={<AiFillDashboard style={{ fontSize: '20px' }}  /> }  label="Dashboard" to="/" />
            
        <MenuItem icon={<MdAddShoppingCart style={{ fontSize: '20px' }} />} label="Compras" to="/ordenes" />
        <MenuItem icon={<FaFileInvoice  />} label="Facturas" to="/facturas" />
      </VStack>
    </Box>
  );
};
